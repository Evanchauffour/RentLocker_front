                  ...
                  <div className="absolute right-0 mt-2 w-56 origin-top-right bg-white rounded-lg shadow-lg overflow-hidden z-50 border border-gray-100 animate-fadeIn">
                    ...
                    <div className="py-1">
                      <Link href="/profile">
                        <Button
                          variant="ghost"
                          className="w-full flex justify-start px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                    ...
                    <div className="py-1 border-t border-gray-100">
                      <Button
                        variant="ghost"
                        className="w-full flex justify-start px-4 py-2 text-sm text-red-500 hover:bg-red-50"
